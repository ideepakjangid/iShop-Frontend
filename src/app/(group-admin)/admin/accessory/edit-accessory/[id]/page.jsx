...
const EditAccessory = () => {
  ...
  const editAccessoryHandler = async (e) => {
    e.preventDefault();
    ...
    const response = await axiosInstance.put(`/accessory/edit-accessory/${id}`, formData);
    if (response.data.flag == 1) {
  ...
  useEffect(() => {
    axiosInstance.get(`/accessory/${id}`).then((response) => {
      if (response.data.flag == 1) {
        setAccessory(response.data.accessory);
        setCurrentProduct({
          value: response.data.accessory.product?._id,
          label: response.data.accessory.product?.name,
        });
      }
    });
  }, [id]);
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="mb-5 w-full">
            ...
            <Select
              ...
              onChange={(options) => setCurrentProduct(options)}
          ...
          <div className="mb-5 w-full grid grid-cols-3 col-span-2 gap-3">
            <div>
              ...
              <input
                ...
                defaultValue={accessory?.original_price}
            ...
            <div>
              ...
              <input
                ...
                defaultValue={accessory?.discounted_price}
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div>
              ...
              <input
                ...
                defaultValue={accessory?.discount_percent}
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          <div className="mb-5 w-full">
            ...
            {accessory?.image && (
              <ImageUploader
                ...
                imageUrl={`${process.env.NEXT_PUBLIC_BASE_URL}/images/accessory/${accessory.image}`}
              />
            )}
          </div>
        </div>
