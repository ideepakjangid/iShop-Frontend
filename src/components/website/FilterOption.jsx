...
const FilterOption = ({ products, colors }) => {
  ...
  return (
    <div className="w-full bg-[#F6F7F8] text-[14px] p-4 mt-0 sm:mt-8 flex  justify-between md:items-start lg:items-center relative">
      <div className="flex gap-4 md:gap-4 lg:gap-8 gap-y-3 items-center  md:flex-wrap lg:flex-nowrap">
        <span className="hidden sm:block">{products?.length ?? 0} items</span>
        <div className="hidden  sm:flex gap-2 items-center">
          <label htmlFor="sort_by">Sort By Name:</label>
          <select
            className="p-1 min-w-[100px] text-[14px] outline-none focus:outline-none"
            name="sort_by"
            value={sortOrder} // Set the value to the state variable
        ...
        <div className="hidden sm:flex gap-2 items-center">
          ...
          <select
            ...
            value={limit}
            name="sort_by_limit"
            className="p-1 md:min-w-[50px] lg:min-w-[100px] text-[14px] outline-none focus:outline-none"
          >
        ...
        <div
          ...
          className={`sm:hidden text-[14px]  flex items-center cursor-pointer gap-1 `}
        >
          <FaFilter />
          <span>Filter</span>
        </div>
      ...
      <div className="-order-1 sm:order-1 flex gap-3 items-center">
        <BsGrid3X3GapFill
